= C++ example project scanned on SonarCloud with test coverage using GitHub Actions
// URIs:
...
*This project is analysed on https://sonarcloud.io/dashboard?id=sonarsource-cfamily-examples_linux-cmake-gcovr-gh-actions-sc[SonarCloud]!*
...
It is very easy to analyze a C, C++ and Objective-C project and compute its *test coverage* with SonarCloud and https://docs.sonarcloud.io/getting-started/github/[GitHub Actions]:

. Create a `sonar-project.properties` file to store your configuration
. In your `.github/workflows/build.yml` file:
.. Make sure you have gcovr v5.0 (v5.1 is not supported, see https://jira.sonarsource.com/browse/SONAR-16269[SONAR-16269])
...
.. Run `gcovr --sonarqube` to produce the SonarCloud-compatible XML coverage report
